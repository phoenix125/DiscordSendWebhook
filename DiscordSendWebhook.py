...
class DiscordWebhook():
    ...
    def __init__(self, url, content, botname, **kwargs):
        ...
        :keyword botname: override the default username of the webhook
        """
        self.url = url
...
def main():
    ...
    webhook = DiscordWebhook(url=sys.argv[1], content=sys.argv[2], botname=sys.argv[3])
    reply = webhook.execute()
